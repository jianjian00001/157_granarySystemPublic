    ...
    */
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(yonghuEntity==null){
            ...
            return R.error(511,"账户或者保管员手机号或者保管员身份证号已经被使用");
        }
    }
...
//                            yonghuEntity.setYonghuName(data.get(0));                    //保管员姓名 要改的
//                            yonghuEntity.setYonghuPhone(data.get(0));                    //保管员手机号 要改的
//                            yonghuEntity.setYonghuIdNumber(data.get(0));                    //保管员身份证号 要改的
//                            yonghuEntity.setYonghuPhoto("");//详情和图片
//                            yonghuEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            yonghuEntity.setYonghuEmail(data.get(0));                    //保管员邮箱 要改的
//                            yonghuEntity.setCreateTime(date);//时间
                        ...
                        if(yonghuEntities_yonghuPhone.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [保管员手机号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
                         //保管员身份证号
                        ...
                        if(yonghuEntities_yonghuIdNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [保管员身份证号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "粮仓保管员");
        R r = R.ok();
        r.put("token", token);
        r.put("role","粮仓保管员");
...
//    	ValidatorUtils.validateEntity(user);
        ...
        YonghuEntity yonghuEntity = yonghuService.selectOne(queryWrapper);
        if(yonghuEntity != null)
            return R.error("账户或者保管员手机号或者保管员身份证号已经被使用");
        yonghu.setCreateTime(new Date());
        yonghuService.insert(yonghu);
